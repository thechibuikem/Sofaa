...
import { generateStars } from "./createProductBlock.js"; //importing generate stars from createproductBlock
...
// creating a function that actually loads the product details on the product.html page
const displayProductDetails = () => {
  const star = generateStars(product.rating); //basically I am calling the generate stars function because I would then use it to create stars that would ultimately fill up my rating div

  const productDetailsMainSection = document.createElement("main"); //creating the main element
...
target.parentNode.insertBefore(productDetailsMainSection,target.nextElementSibling);

}

// adding the event listener to upload this
